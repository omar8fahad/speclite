...
- **One command, two modes, auto-detected**: `.agents/commands/speclite.map.md` runs
...
gap-check; `.agents/commands/speclite.tasks.md` and `.agents/commands/speclite.implement.md` call this out at
