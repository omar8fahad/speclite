...
- [ ] If `status` reports `MAP_SUGGESTION: build` (this looks like an existing codebase), offer
      `/speclite.map` before starting the first feature - don't run it automatically
