...
Creates specs/NNN-short-name/ with spec.md, the standard references/ subfolders, and the
per-feature logs/ phase folders (2-specify through 5-implement - constitution is always
project-wide, so it has no per-feature folder here).
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    append_log(feature_dir, "specify", "INFO", f"Feature created: {description}")
